...
function cargarDatos(){
  ...
  .then(response =>response.json()) //indico el formato de los datos obtenidos
  .then(data =>{
    showData(data.students);    //le paso a la función showData() los nombres y apellidos accediendo a students de la respuesta obtenida
  })
  .catch(error =>{
